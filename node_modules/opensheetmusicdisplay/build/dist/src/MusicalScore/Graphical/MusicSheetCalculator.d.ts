...
export declare abstract class MusicSheetCalculator {
    ...
    protected handleVoiceEntryArticulations(articulations: ArticulationEnum[], voiceEntry: VoiceEntry, staffEntry: GraphicalStaffEntry): void;
    /**
