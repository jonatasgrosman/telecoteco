...
export declare abstract class VexFlowBackend {
    ...
    abstract renderText(fontHeight: number, fontStyle: FontStyles, font: Fonts, text: string, heightInPixel: number, screenPosition: PointF2D, color?: string): void;
    /**
     ...
     */
    abstract renderRectangle(rectangle: RectangleF2D, styleId: number, alpha: number): void;
    abstract renderLine(start: PointF2D, stop: PointF2D, color: string, lineWidth: number): void;
