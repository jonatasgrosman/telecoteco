...
export declare class VexFlowMusicSheetDrawer extends MusicSheetDrawer {
     ...
     */
    protected drawLine(start: PointF2D, stop: PointF2D, color?: string, lineWidth?: number): void;
     ...
     */
    DrawOverlayLine(start: PointF2D, stop: PointF2D, musicPage: GraphicalMusicPage, color?: string, lineWidth?: number): void;
