...
export declare class VexFlowGraphicalSymbolFactory implements IGraphicalSymbolFactory {
     ...
     */
    createNote(note: Note, graphicalVoiceEntry: GraphicalVoiceEntry, activeClef: ClefInstruction, octaveShift?: OctaveEnum, graphicalNoteLength?: Fraction): GraphicalNote;
    /**
     ...
     * @returns {GraphicalNote}
     */
    createGraceNote(note: Note, graphicalVoiceEntry: GraphicalVoiceEntry, activeClef: ClefInstruction, octaveShift?: OctaveEnum): GraphicalNote;
    /**
     ...
     */
    createChordSymbols(sourceStaffEntry: SourceStaffEntry, graphicalStaffEntry: GraphicalStaffEntry, transposeHalftones: number): void;
    /**
