<template>
  ...
  <div>
    ...
    <v-layout
      ...
      wrap
    >
      <v-flex mb-4 style="max-width: 800px;">
        <h1 class="display-2 font-weight-bold mb-3">
          Sobre o projeto telecote.co
        </h1>
        <p></p>
        <p>
        ...
        <p>
          Apresentamos sessões de exercícios básicas para quem nunca teve contato com música ou leitura de partitura, sessões avançadas que apresentam uma perspectiva histórica dos ritmos e conceitos mais difíceis de internalizar e sessões de apresentação à ritmos organizados por regiões ou por famílias tradicionais.
        ...
        <p>
          Em geral, os gêneros e ritmos do Brasil são tocados com múltiplos instrumentos.
          Da mesma forma que na costa oeste Africana, nossos gêneros são tocados com tambores de diferentes formatos como: atabaque, rum, rumpi, lé, candongueiro, caxambu, surdo, alfaias.
...
export default {
  methods: {
    ...mapMutations(["selectExercise", "goToHello"]),
    selectFirstExercise() {
